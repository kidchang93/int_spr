...
<Form method="post" action="/student/save">
    ...
    <p>국어 : <input type="text" name="korean" placeholder="국어점수를 입력하세요" required ></p>
    <p>영어 : <input type="text" name="english" placeholder="영어점수를 입력하세요" required ></p>
    <p>수학 : <input type="text" name="math" placeholder="수학점수를 입력하세요" required ></p>
